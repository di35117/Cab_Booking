...
const LOCATIONS = {
  ...
  destinations: [
    ...
    { lat: 12.9698, lng: 77.75, address: "Whitefield, Bangalore" },
    ...
    { lat: 13.0418, lng: 77.58, address: "Malleshwaram, Bangalore" },
...
async function main() {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    const destination =
      LOCATIONS.destinations[i % LOCATIONS.destinations.length];
